...
KartPad `v0.3.0-preview.1` is an unsigned ARM64 IPA for iPhone and iPad. It is a
...
1. Download `KartPad-v0.3.0-preview.1-unsigned.ipa` and `SHA256SUMS` from the
   [0.3.0 Preview 1 release](https://github.com/chrissotraidis/kartpad/releases/tag/v0.3.0-preview.1).
