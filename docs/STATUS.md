...
| G10 macOS offline compatibility | In progress | Row 22 is 6/32 tracks Pass; ghost sync, save safety, vehicles/drift, items/AI/collisions, Battle rows 27–28, two-player row 29, four controller slots, and explicit GameCube-adapter limitation pass. Continue tracks/cups/modes, three/four-player races, and audio/save rows |
