...
| G10 macOS offline compatibility | In progress | Row 22 is 31/32 tracks Pass with complete Mushroom/Flower/Star/Shell/Banana/Leaf/Special Cup subsets and Lightning Cup 3/4; ghost sync, save safety, vehicles/drift, items/AI/collisions, Battle rows 27–28, two-player row 29, four controller slots, and explicit GameCube-adapter limitation pass. Continue the last track, modes, honest Grand Prix progression, three/four-player races, and audio/save rows |
