...
- Full mobile game app: a freshly serialized upstream integration compiles all 29,065 base translated functions into an Xcode-produced arm64 `IOSSIMULATOR` app. SDL owns the UIKit scene lifecycle; the real SDL/Metal window receives the byte-identical SunPad overlay, and its mixer feeds the retail Classic Controller ABI. The resolved iPhone/iPad bundle, original compiled icon catalog, privacy/runtime resources, system-only linkage, and forbidden-private-data audit pass. Executable SHA-256 is `9a5d69076299324e7f33ae10366a97cdccc512dc4af87c0d77fcdb4af35d4ca0`. It has not yet been launched. Evidence: `docs/artifacts/2026-08-30/g14-full-game-app.md`.
...
The local `ref/sunpad` checkout is the direct implementation reference for the mobile touch interface and persistent three-dot menu. A byte-identical, pinned nine-file snapshot runs directly in the native arm64 shell on both iPhone 17 Pro and iPad Pro 13-inch Simulator classes, exercised sequentially. It is now also compiled unchanged into the full 29,065-function retail app and attached above Aurora's real SDL/UIKit Metal window; a separate KartPad adapter feeds its mixer into the retail Classic Controller ABI. The full Xcode app's lifecycle, resolved identity, original icon catalog, privacy/runtime resources, system-only linkage, exact snapshot, and forbidden-private-data audit pass. No Simulator remains booted, and this full-game app has not yet been launched. Real data/settings services, Metal gameplay, audio, save, complete races, controller handoff, gyro, and touch-feel acceptance remain open. Evidence: `docs/artifacts/2026-08-30/g14-simulator-shell/`, `docs/artifacts/2026-08-30/g14-full-runtime-link.md`, and `docs/artifacts/2026-08-30/g14-full-game-app.md`.
