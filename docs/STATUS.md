...
| G10 macOS offline compatibility | In progress | Row 22 is 27/32 tracks Pass with complete Mushroom/Flower/Shell/Banana/Leaf Cup subsets, Star Cup 3/4, and Special/Lightning Cups 2/4 each; ghost sync, save safety, vehicles/drift, items/AI/collisions, Battle rows 27–28, two-player row 29, four controller slots, and explicit GameCube-adapter limitation pass. Continue tracks, modes, honest Grand Prix progression, three/four-player races, and audio/save rows |
