...
| G10 macOS offline compatibility | In progress | Row 22 is 12/32 tracks Pass with complete Mushroom/Flower/Shell Cup subsets; ghost sync, save safety, vehicles/drift, items/AI/collisions, Battle rows 27–28, two-player row 29, four controller slots, and explicit GameCube-adapter limitation pass. Continue tracks, modes, three/four-player races, and audio/save rows |
